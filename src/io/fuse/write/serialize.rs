...
fn write_fixed_size_binary<W: Write>(
    w: &mut W,
    array: &FixedSizeBinaryArray,
    _buffers: &mut Vec<ipc::Buffer>,
    _arrow_data: &mut Vec<u8>,
    _offset: &mut i64,
    ...
    write_bitmap(w, array.validity(), compression, scratch)?;
    write_bytes(w, array.values(), compression, scratch)
}

fn write_list<O: Offset, W: Write>(
    w: &mut W,
    array: &ListArray<O>,
    is_little_endian: bool,
    compression: Option<Compression>,
